...
export class BurgerBuilder extends Component {
    ...
    purchaseHandler = () => {
        if (this.props.isAuthenticated) {
            ...
            // If the user click sign up to order button 
            // after building a burger, set the redirect
            // path to checkout, so after singin page 
            // they will be redirected to checkout page 
